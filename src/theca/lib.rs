...
mod tests {
    ...
    fn test_add_note() {
        ...
        assert!(p.add_note(&"this is a title".to_string(), &vec![], false, false, false, false).is_ok());
    ...
    fn test_add_started_note() {
        ...
        assert!(p.add_note(&"this is a title".to_string(), &vec![], true, false, false, false).is_ok());
        assert_eq!(p.notes.len(), 1);
        assert_eq!(p.notes[0].id, 1);
        assert_eq!(p.notes[0].title, "this is a title".to_string());
    ...
    fn test_add_urgent_note() {
        ...
        assert!(p.add_note(&"this is a title".to_string(), &vec![], false, true, false, false).is_ok());
        assert_eq!(p.notes.len(), 1);
        assert_eq!(p.notes[0].id, 1);
        assert_eq!(p.notes[0].title, "this is a title".to_string());
    ...
    fn test_add_basic_body_note() {
        ...
        assert!(p.add_note(&"this is a title".to_string(), &vec!["and what?".to_string()], false, false, false, false).is_ok());
        assert_eq!(p.notes.len(), 1);
        assert_eq!(p.notes[0].id, 1);
        assert_eq!(p.notes[0].title, "this is a title".to_string());
        assert_eq!(p.notes[0].status, "".to_string());
    ...
    fn test_add_full_basic_body_note() {
        ...
        assert!(p.add_note(&"this is a title".to_string(), &vec!["and what?".to_string()], false, true, false, false).is_ok());
        assert_eq!(p.notes.len(), 1);
        assert_eq!(p.notes[0].id, 1);
        assert_eq!(p.notes[0].title, "this is a title".to_string());
        assert_eq!(p.notes[0].status, "Urgent".to_string());
